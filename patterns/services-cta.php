...
<div class="wp-block-column"><!-- wp:image {"scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"16px"}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/tt4_services_1.png" alt="<?php echo esc_attr__( 'Picture of a man holding a roll of building plans', 'twentytwentyfour' ); ?>" style="border-radius:16px;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
