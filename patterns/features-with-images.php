...
<div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"layout":{"selfStretch":"fit","flexSize":null},"elements":{"link":{"color":{"text":"var:preset|color|custom-borders"}}}},"textColor":"custom-borders","fontSize":"x-large"} -->
<p class="has-text-align-center has-custom-borders-color has-text-color has-link-color has-x-large-font-size">✳︎</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:paragraph {"align":"left","style":{"layout":{"selfStretch":"fit","flexSize":null},"elements":{"link":{"color":{"text":"var:preset|color|custom-borders"}}}},"textColor":"custom-borders","fontSize":"x-large"} -->
<p class="has-text-align-left has-custom-borders-color has-text-color has-link-color has-x-large-font-size">✳︎</p>
<!-- /wp:paragraph -->
