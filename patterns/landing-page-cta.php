...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/message_icon.png" alt="" class="wp-image-8" style="object-fit:cover;width:45px;height:49px" width="45" height="49"/></figure>
<!-- /wp:image -->
...
<h2 class="wp-block-heading has-text-align-center has-cardo-font-family" style="font-size:48px;font-style:normal;font-weight:500;line-height:1.5">Subscribe to the newsletter and stay connected with our community.</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button has-custom-font-size" style="font-size:16px;font-style:normal;font-weight:800"><a class="wp-block-button__link has-text-align-center wp-element-button" style="border-radius:6px;padding-top:17px;padding-right:28px;padding-bottom:17px;padding-left:28px">Sign Up</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->