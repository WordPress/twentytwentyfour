...
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icon-message.png" alt="<?php echo esc_attr( 'Message Icon for Newsletter', 'twentytwentyfour' ); ?>" style="object-fit:cover;width:45px;height:49px" width="45" height="49"/></figure>
<!-- /wp:image -->
