...
<div class="wp-block-group alignwide has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:8.75rem;padding-right:5.625rem;padding-bottom:8.75rem;padding-left:5.625rem">
  ...
  <p class="has-text-align-center has-inter-font-family" style="margin-top:0.25rem;font-style:normal;font-weight:300"><?php echo esc_html_x( 'CEO, Greenprint', 'Designation of Person Provided Testimonial', 'twentytwentyfour' ); ?></p>
  <!-- /wp:paragraph -->
