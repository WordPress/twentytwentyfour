...
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"2rem"}},"typography":{"lineHeight":"1.2"}},"textColor":"base","fontSize":"xx-large","fontFamily":"cardo"} -->
<p class="has-text-align-center has-base-color has-text-color has-cardo-font-family has-xx-large-font-size" style="margin-bottom:2rem;line-height:1.2"><em><?php echo esc_html_x( '“Études has saved us thousands of hours of work and has unlocked insights we never thought possible.”', 'Testimonial Text or Review Text Got From the Person', 'twentytwentyfour' ); ?></em></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image aligncenter size-thumbnail is-resized has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/testimonial-avatar.webp" alt="<?php echo esc_attr( 'Portrait of a woman looking down Side', 'twentytwentyfour' ); ?>" class="" style="border-radius:999px;object-fit:cover;width:64px;height:64px" width="64" height="64" /></figure>
<!-- /wp:image -->
