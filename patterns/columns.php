...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html_x( 'We recognize the crucial role architecture plays in shaping a sustainable future.', 'Heading of the Columns', 'twentytwentyfour' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
