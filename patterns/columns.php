...
<h3 class="wp-block-heading"><?php echo esc_html_x( 'We recognize the crucial role architecture plays in shaping a sustainable future.', 'Heading Text', 'twentytwentyfour' )?></h3>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'Our vision is to be at the forefront of architectural innovation, fostering a global community of architects and enthusiasts united by a passion for creating spaces.', 'Vision Text', 'twentytwentyfour' )?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
