...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/tt4_writer_avatar-1024x1024.jpg" alt="<?php echo esc_attr__( 'Portrait of a woman smiling', 'twentytwentyfour' ); ?>" style="object-fit:cover;width:80px;height:80px" width="80" height="80"/></figure>
<!-- /wp:image -->
